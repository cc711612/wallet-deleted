...
class WalletDetailDestroyRequest extends Request
{
    /**
     * @return null[]
     * @Author  : Roy
    ...
    protected function schema(): array
    {
        return [
            ...
            'wallet_details.deleted_by' => null,
            'wallet_details.deleted_at' => Carbon::now()->toDateTimeString(),
            'wallet_user'               => null,
        ];
    }
    ...
    protected function map($row): array
    {
        return [
            ...
            'wallet_details.deleted_by' => Arr::get($row,
                sprintf("wallet_user.%s.id", Arr::get($row, 'wallet'))),
